	...
	switch r.URL.Path{
		...
		case `/manager/`:
			...
			for rows.Next() {	
				...
				fmt.Fprintf(w,`<tr><td width="2%%">%d</td><td width="10%%">%s</td><td width="3%%">%s</td><td width="20%%">%s</td><td width="20%%">%s</td><td width="10%%">%s</td><td width="20%%">%s</td><td width="5%%">%d</td></tr>`,visitid,visitime,visitmethod,visiturl,visithead,rsp_status,rsp_head,rsp_length)
			}
